<?php
/*
* Changed the appriopriate bits to reflect PostgreSQL quirks,
* the original was adjusted to MySQL
*/
...
/*
foreach ($resFilterLength as $k=> $v) {
  echo $k.' '.gettype($k)."\n";
 foreach ($v as $j=>$v2) {
  echo $j.' '.gettype($j)."\n";
  echo '  '.$j.' '.$v2."\n";
